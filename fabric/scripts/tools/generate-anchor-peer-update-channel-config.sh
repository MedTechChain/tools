...
jq '.channel_group.groups.Application.groups.'"$GROUP_NAME"'.values += {"AnchorPeers":{"mod_policy": "Admins","value":{"anchor_peers": [{"host": "'"$PEER"'","port": 7051}]},"version": "0"}}' config_copy.json >modified_config.json
