...
peer channel create -f /var/hyperledger/artifacts/channel/$ORG_PEER_ADDRESS/$CHANNEL_ID-channel.tx \
    --outputBlock /var/hyperledger/artifacts/channel/$ORG_PEER_ADDRESS/$CHANNEL_ID.block \
    -c $CHANNEL_ID \
