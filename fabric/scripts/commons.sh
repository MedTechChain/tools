...
declare -A PEER_HOST_PORTS
declare -A CHAINCODE_HOST_PORTS
PEER_HOST_PORT=8051
CHAINCODE_HOST_PORT=8052
for ORG_PEER_ID in ${ORG_PEER_IDS[@]}; do
    PEER_HOST_PORTS[$ORG_PEER_ID]="$PEER_HOST_PORT"
    CHAINCODE_HOST_PORTS[$ORG_PEER_ID]="$CHAINCODE_HOST_PORT"
    ((PEER_HOST_PORT += 1000)) 
    ((CHAINCODE_HOST_PORT += 1000)) 
done
